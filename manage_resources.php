...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO resources (event_id, file_name, file_type) VALUES (?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("iss", $event_id, $file_name, $file_type);
...
<body>
    ...
    <!-- Upload Resource Start -->
    <div class="container-xxl py-5">
        <div class="container">
            <h1 class="text-center mb-5">Upload Resource</h1>
